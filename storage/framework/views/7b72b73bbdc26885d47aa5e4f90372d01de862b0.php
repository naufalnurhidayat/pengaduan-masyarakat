        ...
        <div class="col-md8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        <a href="<?php echo e(url('/admin/report')); ?>" class="btn btn-primary">Kembali</a>
                        <?php if($pengaduan->status == '0'): ?>
                            <form action="<?php echo e(url('/admin/report/process/' . $pengaduan->id)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('patch'); ?>
                                <button type="submit" class="btn btn-warning">Proses Laporan Ini</button>
                            </form>
                            <a href="<?php echo e(url('/admin/report/respond/' . $pengaduan->id )); ?>" class="btn btn-success">Tanggapi dan Selesai</a>
                        <?php elseif($pengaduan->status == 'proses'): ?>
                            <a href="<?php echo e(url('/admin/report/respond/' . $pengaduan->id )); ?>" class="btn btn-success">Tanggapi dan Selesai</a>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('templates.template-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pengaduanMasyarakat\resources\views/admin/detail-report.blade.php ENDPATH**/ ?>