...
<?php $__env->startSection('title', 'Registrasi Petugas'); ?>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo e(url('/admin/regist')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                            <div class="form-row">
                                                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="<?php echo e(url('/admin')); ?>">Kembali</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('templates/template-auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pengaduanMasyarakat\resources\views/admin/regist.blade.php ENDPATH**/ ?>