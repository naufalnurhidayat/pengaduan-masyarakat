                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(url('/admin/petugaslist')); ?>">Daftar Petugas</a>
                                    <a class="nav-link" href="<?php echo e(url('/admin/regist')); ?>">Registrasi Petugas</a>
                                    <a class="nav-link" href="<?php echo e(url('/admin/profile')); ?>">My Profile</a>
                                </nav>
                            </div>
                            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseMasyarakat" aria-expanded="false" aria-controls="collapseMasyarakat">
                                <div class="sb-nav-link-icon"><i class="fas fa-user"></i></div>
                                Masyarakat
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseMasyarakat" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(url('/admin/masyarakatlist')); ?>">Daftar Masyarakat</a>
                                    <a class="nav-link" href="<?php echo e(url('/admin/report')); ?>">Laporan Masyarakat</a>
                                </nav>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\pengaduanMasyarakat\resources\views/templates/template-admin.blade.php ENDPATH**/ ?>