...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="<?php echo e(url('/admin/profile')); ?>">Kembali</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('templates/template-auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pengaduanMasyarakat\resources\views/admin/edit-profile.blade.php ENDPATH**/ ?>