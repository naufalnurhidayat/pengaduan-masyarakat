...
<?php $__env->startSection('title', 'Ubah Akun'); ?>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Ubah Data Anda</h3></div>
                                    <div class="card-body">
                                        <form action="<?php echo e(url('/account/edit')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="<?php echo e(url('/account')); ?>">Kembali</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('templates.template-masyarakat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pengaduanMasyarakat\resources\views/masyarakat/edit.blade.php ENDPATH**/ ?>