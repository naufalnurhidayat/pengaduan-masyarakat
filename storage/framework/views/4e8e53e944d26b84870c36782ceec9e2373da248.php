...
<?php $__env->startSection('title', 'Registrasi Masyarakat'); ?>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="<?php echo e(url('/regist')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                            <div class="form-row">
                                                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4 <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4 <?php $__errorArgs = ['password2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="password2" type="password" placeholder="Konfirmasi Password" name="password2" required value="<?php echo e(old('password2')); ?>" />
...
unset($__errorArgs, $__bag); ?>" id="email" type="email" placeholder="Email" name="email" required value="<?php echo e(old('email')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="<?php echo e(url('/login')); ?>">Masuk</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@endsectionx
<?php echo $__env->make('templates/template-auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pengaduanMasyarakat\resources\views/masyarakat/regist.blade.php ENDPATH**/ ?>