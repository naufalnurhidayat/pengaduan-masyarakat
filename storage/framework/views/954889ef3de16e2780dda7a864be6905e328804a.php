...
<div class="row mt-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card bg-success text-white mb-4">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between">
                <h6><?php echo e(count($laporan)); ?></h6>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6">
...
<?php echo $__env->make('templates/template-petugas', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pengaduanMasyarakat\resources\views/petugas/index.blade.php ENDPATH**/ ?>